...
There are a few keys that the user needs to acquire and replace in files (currently mentioned as blanks). Following is a list -

1. Dark Sky API Key -- Replace in update_service/ingest_config.cfg
2. Monitoring email from, email to and password -- Replace in update_service/ingest_config.cfg
3. Google Maps API Key -- Replace in myapp/templates/incidentsPlot.html
